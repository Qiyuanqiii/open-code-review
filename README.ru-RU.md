...
- **Git >= 2.41** — требуется для ревью рабочей копии, коммита и диапазона Git.
- **Subversion >= 1.7 (необязательно)** — требуется для ревью рабочей копии SVN, одной ревизии или диапазона ревизий.
...
# Рабочая копия Git — ревью всех staged, unstaged и untracked изменений
ocr review

# Рабочая копия Subversion — ревью версионируемых и неверсионируемых локальных изменений
cd your-svn-working-copy
ocr review

# Неизменяемая история Subversion — одна ревизия или явный диапазон ревизий
ocr review --commit 128
ocr review --from 120 --to 128

# Диапазон веток Git — изменения feature-branch с момента её отделения от main (режим merge-base)
