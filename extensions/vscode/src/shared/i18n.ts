...
const messages: Record<SupportedLocale, Record<string, string>> = {
  en: {
    ...
    'view.idle.selectRange': 'Enter both revisions',
    'view.idle.selectRevision': 'Enter a revision',
    ...
    'view.idle.revisionRange': 'Revision Range',
    'view.idle.revision': 'Single Revision',
    ...
    'view.idle.baseRevision': 'Start revision',
    'view.idle.targetRevision': 'End revision',
    'view.idle.revisionNumber': 'Revision',
    'view.idle.enterRevision': 'Number, HEAD, or {2026-01-01}',
    'view.idle.svnSourceTarget': 'Source repository path (optional)',
    'view.idle.svnDestinationTarget': 'Destination repository path (optional)',
    'view.idle.svnTargetsHelp': 'Provide both targets for a remote path comparison. Configure credentials in SVN; never embed them in a URL.',
    'view.idle.detectedGit': 'Git workspace',
    'view.idle.detectedSvn': 'SVN workspace',
    'view.idle.noRepository': 'No VCS detected',
    ...
    'ext.svn.previewFailed': 'SVN preview failed:',
    'ext.svn.snapshotSidebarOnly': 'Immutable SVN files are reviewed from repository snapshots and are shown in the sidebar only.',
    'ext.repository.pathOutsideWorkspace': 'Refusing to open a file outside the current workspace.',
  },
  ...
  'zh-cn': {
    ...
    'view.idle.selectRange': '请输入起止版本',
    'view.idle.selectRevision': '请输入版本号',
    'view.idle.noFiles': '无可审查文件',
    'view.idle.reviewAll': '审查所有变更',
    'view.idle.workspace': '工作区',
    'view.idle.branch': '分支对比',
    'view.idle.commit': '单次提交',
    'view.idle.revisionRange': '版本范围',
    'view.idle.revision': '单个版本',
    'view.idle.baseRef': '基础引用',
    'view.idle.targetRef': '目标引用',
    'view.idle.chooseBranch': '选择分支',
    'view.idle.commitHistory': '提交历史',
    'view.idle.baseRevision': '起始版本',
    'view.idle.targetRevision': '目标版本',
    'view.idle.revisionNumber': '版本号',
    'view.idle.enterRevision': '数字、HEAD 或 {2026-01-01}',
    'view.idle.svnSourceTarget': '源仓库路径（可选）',
    'view.idle.svnDestinationTarget': '目标仓库路径（可选）',
    'view.idle.svnTargetsHelp': '远端路径对比需要同时填写两个目标。凭据应配置在 SVN 中，切勿嵌入 URL。',
    'view.idle.detectedGit': 'Git 工作区',
    'view.idle.detectedSvn': 'SVN 工作区',
    'view.idle.noRepository': '未检测到版本库',
    ...
    'ext.svn.previewFailed': 'SVN 预览失败：',
    'ext.svn.snapshotSidebarOnly': '不可变 SVN 文件从仓库快照中审查，仅在侧边栏中显示。',
    'ext.repository.pathOutsideWorkspace': '已拒绝打开当前工作区之外的文件。',
  },
};
