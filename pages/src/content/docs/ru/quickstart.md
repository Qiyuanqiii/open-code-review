...
- **Git ≥ 2.41** для ревью Git или **Subversion ≥ 1.7** для ревью рабочей копии SVN
- **Node.js ≥ 18**
...
Для SVN поддерживается только режим рабочей области: `ocr review` включает
версионируемые и неверсионируемые локальные изменения. Примеры диапазона веток
и отдельного коммита выше требуют Git.
